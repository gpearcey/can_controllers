...
static TaskHandle_t N2K_stats_task_handle = nullptr;
...
{   
    ...
    for (;;)
    {
        ...
        //vTaskDelay(1000 / portTICK_PERIOD_MS); // 10 s delay
...
//
    ...
    while(1)
    {
        ESP_LOGD(TAG_TWAI_RX,"receive task");
...
extern "C" int app_main(void)
{
    ...
    xTaskCreate(
        ...
        "N2K_receive_task",           // A descriptive name for the task for debugging.
        3072,                 // size of the task stack in bytes.
        NULL,                 // Optional pointer to pvParameters
